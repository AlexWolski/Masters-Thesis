...
\usepackage{amsmath,amsthm,amssymb, amsfonts, amssymb, amsxtra,amsopn}
\usepackage{graphicx}
\usepackage{multirow}
...
\DeclareMathOperator{\primitive}{primitive}
...
% References - using uriref.bst
\reffile{References}

% Indicate the placement of the appendix to place the bibliography without an actual appendix.
\startappendix
