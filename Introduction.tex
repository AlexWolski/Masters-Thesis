...
\begin{figure}
	...
	\begin{subfigure}[t]{0.3\textwidth}
		...
		\caption{Intersect}
	\end{subfigure}
	\caption{Three different boolean operations applied to two spheres. a) Union operation includes all points encompassed by either sphere, b) Subtract operation includes points encompassed by the first sphere but not the second sphere, c) Intersect operation includes points encompassed by both spheres.}
